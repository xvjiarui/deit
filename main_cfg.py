...
def get_args_parser():
    parser = argparse.ArgumentParser('DeiT training and evaluation script with cfg', add_help=False)
...
def main(args):
    ...
    model_ema = None
    if args.model_ema:
        print(f'Model EMA with {args.model_ema_decay}')
