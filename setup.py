...
if __name__ == '__main__':
    setup(
        ...
        url='https://github.com/xvjiarui/deit',
        packages=find_packages(),
        include_package_data=True,
        package_data={'deit.ops': ['*/*.so']},
        classifiers=[
